...
//            return null;		// disabled ring size limit, TLS 20130613
    ...
    /*
     *  An atom's ringsize is the size of the smallest ring the atom is a member of.
     *  If the atom doesn't belong to any ring the ringsize is 0. If the ringsize is
     *  greater then the ringsize limit of this class, then also 0 is returned.
     */
