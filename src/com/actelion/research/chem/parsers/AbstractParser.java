...
public abstract class AbstractParser {
	 ...
	 */
	public final List<FFMolecule> loadGroup(String fileName) throws Exception {
		Reader r = null;
		try {
			...
			List<FFMolecule> mols = loadGroup(fileName, r, -1, -1);
			int count = 0;
	...
	public List<FFMolecule> loadGroup(String fileName, Reader in) throws Exception{
		return loadGroup(fileName, in, -1, -1);
	}
	public abstract List<FFMolecule> loadGroup(String fileName, Reader in, int from, int to) throws Exception;
	 ...
	 * @throws ActelionException
	 */
	public final FFMolecule load(String fileName) throws Exception {
		List<FFMolecule> list = loadGroup(fileName);
	 ...
	 * @throws ActelionException
	 */
	public final FFMolecule load(String fileName, Reader in) throws Exception {
		List<FFMolecule> list = loadGroup(fileName, in, -1, -1);
		return list.size()>0? list.get(0): null;
	}
	 ...
	 * @throws ActelionException
	 */ 
	public final void save(List<FFMolecule> mol, String fileName) throws Exception {
		Writer w = null;
		try {
			if(fileName.toUpperCase().endsWith(".GZ")) {
	 ...
	 * @throws ActelionException
	 */
	public final void save(FFMolecule mol, String fileName) throws Exception {
		Writer w = null;
		try {
			if(fileName.toUpperCase().endsWith(".GZ")) {
				GZIPOutputStream os = new GZIPOutputStream(new FileOutputStream(fileName));
	...
	public static final void convertDataToPrimitiveTypes(List<FFMolecule> res) {
	...
	protected static boolean is3D(ExtendedMolecule m) {
